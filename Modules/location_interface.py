...
def get_location_info(search_location_original: str, api: str = API_KEY) -> List[int]:
    ...
    if response.status_code == 200:
        ...
        if 'items' in data and data['items']:
            ...
            row = [search_location, region_name,
                   country_code, longitude, latitude, region_map]
            # build row here
    ...
    print(f"Error: Location lookup error. Program cannot find {
          search_location_original}")
